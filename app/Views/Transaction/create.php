            ...
            <form method="post" action="<?= base_url('transaction/store') ?>">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <select required id="delivery" class="form-control" onchange="package(1)">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="deliv-price" aria-label="Amount (to the nearest dollar)" value=<?php echo $deliveryPrice  ?> readonly>
