...
<div class="card border-left-secondary shadow mb-4">
    ...
    <div class="card-header  py-6">
            <h6 class="m-0 font-weight-bold text-primary">To Pick Up</h6>
        </div>
                            ...
                            <tr class="">
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <a method href="<?= base_url('tracking/2/'. $transaction->id .'/status') ?>" data-href="<?= base_url('tracking/2/'. $transaction->id .'/status') ?> ?>" class="btn btn-sm btn-success">Done</a>
